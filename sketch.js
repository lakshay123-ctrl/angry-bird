...
function preload() {
    birdSound = loadSound("bird_select.mp3");
    birdSound2 = loadSound("bird_flying.mp3");
...
function mouseDragged(){
    if (gameState!=="launched"){
        ...
        Matter.Baody.applyForce(birds[birds.length-1].body,birds[birds.length-1].body.position,{x:5,y:-5})
        return false;
    }
}
